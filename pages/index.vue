...
import Breadcrumb from "./AsheetReact/Breadcrumb.vue";
...
const pages = [
  { path: '#a', label: 'Label 1' },
  { path: '#b', label: 'Label 2' },
  { path: '#c', label: 'Label 3' },
]
</script>

<template>
  <Breadcrumb class="mt-10" :pages="pages" currentPage="Label 1 curr page"></Breadcrumb>
  <!-- <div>
    <NuxtLayout>
